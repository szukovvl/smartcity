...
public final class SerialElementAddresses {
    ...
    public final static byte DIESEL_GENERATOR_1 = 0x03; // дизель генератор #1
    public final static byte DIESEL_GENERATOR_2 = 0x04; // дизель генератор #2
    public final static byte DIESEL_GENERATOR_3 = 0x05; // дизель генератор #3
    public final static byte DIESEL_GENERATOR_4 = 0x06; // дизель генератор #4
    public final static byte DIESEL_GENERATOR_5 = 0x07; // дизель генератор #5
    public final static byte BATTERY_1 = 0x08; // аккумулятор #1
    public final static byte BATTERY_2 = 0x09; // аккумулятор #2
    public final static byte BATTERY_3 = 0x0A; // аккумулятор #3
    public final static byte BATTERY_4 = 0x0B; // аккумулятор #4
    public final static byte BATTERY_5 = 0x0C; // аккумулятор #5
    public final static byte DISTRICT_1 = 0x0D; // микрорайон #1
    public final static byte DISTRICT_2 = 0x0E; // микрорайон #2
    public final static byte DISTRICT_3 = 0x0F; // микрорайон #3
    public final static byte DISTRICT_4 = 0x10; // микрорайон #4
    public final static byte DISTRICT_5 = 0x11; // микрорайон #5
    public final static byte DISTRICT_6 = 0x12; // микрорайон #6
    public final static byte DISTRICT_7 = 0x13; // микрорайон #7
    public final static byte DISTRICT_8 = 0x14; // микрорайон #8
    public final static byte DISTRICT_9 = 0x15; // микрорайон #9
    public final static byte SOLAR_BATTERY_1 = 0x16; // солнечная батарея #1
    public final static byte SOLAR_BATTERY_2 = 0x17; // солнечная батарея #2
    public final static byte SOLAR_BATTERY_3 = 0x18; // солнечная батарея #3
    public final static byte SOLAR_BATTERY_4 = 0x19; // солнечная батарея #4
    public final static byte SOLAR_BATTERY_5 = 0x1A; // солнечная батарея #5
    public final static byte WIND_GENERATOR_1 = 0x1B; // ветрогенератор #1
    public final static byte WIND_GENERATOR_2 = 0x1C; // ветрогенератор #2
    public final static byte WIND_GENERATOR_3 = 0x1D; // ветрогенератор #3

    public final static byte CONTROL_BLOCK = 0x61; // блок управления
    public final static byte CONTROL_BLOCK_CONNECTOR_1 = 0x1E;
    public final static byte CONTROL_BLOCK_CONNECTOR_2 = 0x1F;
    public final static byte CONTROL_BLOCK_CONNECTOR_3 = 0x20;
